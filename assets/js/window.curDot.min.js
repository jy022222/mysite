            ...
            r = function () {
                ...
                var k = function o() {
                    var e = p.x - f.x,
                        t = p.y - f.y;
                    f.x += e / b, f.y += t / b;
                    var r = "translate3d(".concat(f.x - f.d / 2, "px,").concat(f.y - f.d / 2, "px,0)");
                    g.style.webkitTransform = r, g.style.transform = r;
                    var n = p.o - f.o;
                    f.o += n / b, g.style.opacity = f.o;
                    var d = p.d - f.d;
                    f.d += d / b, g.style.height = f.d + "px", g.style.width = f.d + "px";
                    try {
                ...
                return g.over = function (r, n) {
                    var d = function (o) {
                        o.addEventListener("mouseover", function (o) {
                            n.background && (g.style.backgroundColor = n.background), n.borderColor && (g.style.borderColor = n.borderColor), n.scale && (p.d = a * n.scale)
                        }), o.addEventListener("mouseout", function (o) {
                            n.background && (g.style.backgroundColor = x), n.borderColor && (g.style.borderColor = u), n.scale && (p.d = a)
                        })
                    };
